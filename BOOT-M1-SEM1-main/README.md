...
- [Qué es Flutter y por qué usarlo](https://github.com/fhernandezUcamp/BootcampFlutter/blob/main/BOOT-M1-SEM1-main/README.md#qu%C3%A9-es-flutter-y-por-qu%C3%A9-usarlo)
...
- [Los requisitos previos para crear aplicaciones con Flutter](https://github.com/fhernandezUcamp/BootcampFlutter/blob/main/BOOT-M1-SEM1-main/README.md#los-requisitos-previos-para-crear-aplicaciones-con-flutter)
   - [Requisitos técnicos](https://github.com/fhernandezUcamp/BootcampFlutter/blob/main/BOOT-M1-SEM1-main/README.md#requisitos-t%C3%A9cnicos)
   - [Requisitos de conocimiento](https://github.com/fhernandezUcamp/BootcampFlutter/blob/main/BOOT-M1-SEM1-main/README.md#requisitos-de-conocimiento)
...
Flutter se define como un SDK de Google creado para diseñar interfaces nativas iOS y Android, el cual se ha extendido en los últimos años, mencionado que nos encontramos en el 2022, ya se puede desarrollar aplicaciones de escritorio y web con la misma base de código. Se decidió lanzarlo como un proyecto de código abierto, lo cual la comunidad lo adopto muy bien  derivado que emplea  el lenguaje de programación DART que este tiene un gran parecido a varios lenguajes de programación ya existentes en el mercado.

Mencionando algunas de las principales ventajas de utilizar Flutter, tenemos las siguientes:
- Compila en nativo
- La creación de interfaces gráficas son muy flexibles 
...
![image](https://profile.es/wp-content/media/Stateful-Hot-Reload-de-Flutter.gif)
